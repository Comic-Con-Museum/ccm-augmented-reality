...
/// <summary>
/// A custom handler for Vuforia initialization errors which notifies the native app
/// of the error code.
/// 
/// Extends the behavior of Vuforia's DefaultInitializationErrorHandler.
/// </summary>
public class InitializationErrorNotifier : VuforiaMonoBehaviour
{
    ...
    public void OnVuforiaInitializationError(VuforiaUnity.InitError initError)
    {
        ...
        {
            NativeAppInterface.NotifyVuforiaLoaded((int)initError);
